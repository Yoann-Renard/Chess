...
/*    
char* input_case(void)
{
    char *input = (char*)malloc(20*sizeof(char));
    printf("\nEntrer la pièce à déplacer\n");
    scanf("%2s", input);
...
char* recherche_case(Echiquier plateau[8][8])
{
    int i;
    int j;
    int x;
